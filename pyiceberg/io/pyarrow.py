...
"""PyArrow-based data operations for reading and writing Iceberg table files.

This module contains schema conversion, expression translation, scan orchestration,
Parquet read/write, and statistics collection using PyArrow. The FileIO implementation
(PyArrowFileIO) has been extracted to ``pyiceberg.io._pyarrow_fileio`` and is re-exported
...
# Re-export FileIO classes from their new module for backward compatibility.
from pyiceberg.io._pyarrow_fileio import BUFFER_SIZE as BUFFER_SIZE  # noqa: E402
from pyiceberg.io._pyarrow_fileio import ONE_MEGABYTE as ONE_MEGABYTE  # noqa: E402
from pyiceberg.io._pyarrow_fileio import PyArrowFile as PyArrowFile  # noqa: E402
from pyiceberg.io._pyarrow_fileio import PyArrowFileIO as PyArrowFileIO  # noqa: E402
from pyiceberg.io._pyarrow_fileio import PyArrowLocalFileSystem as PyArrowLocalFileSystem  # noqa: E402
