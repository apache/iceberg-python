...
*/
  ...
  __pyx_t_7 = __pyx_f_7cpython_5array_5array_4data_data(__pyx_v_newarray); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 101, __pyx_L1_error)
...
static int __Pyx_modinit_type_import_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  sizeof(arrayobject), __PYX_GET_STRUCT_ALIGNMENT_3_2_2(arrayobject),
  #endif
  __Pyx_ImportType_CheckSize_Warn_3_2_2); if (!__pyx_mstate->__pyx_ptype_7cpython_5array_array) __PYX_ERR(2, 69, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
