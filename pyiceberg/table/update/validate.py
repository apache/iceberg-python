...
class DeleteFileIndex:
    ...
    def _add_pos_deletes(
        ...
        if file_path := entry.data_file.file_path:
            ...
            pos_deletes_by_partition.compute_if_absent(spec_id, partition, deletes, _PositionDeletes)
    ...
    def _add_eq_deletes(
        ...
        if spec := spec_by_id.get(entry.data_file.spec_id):
            if spec.is_unpartitioned():
                ...
                eq_deletes_by_partition.compute_if_absent(spec_id, partition, deletes, _EqualityDeletes)
