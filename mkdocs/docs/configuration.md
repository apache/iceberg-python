...
| `write.parquet.content-defined-chunking.min-chunk-size` | Size in bytes       | 262144                     | The minimum chunk size used for content-defined chunking                                                                                             |
| `write.parquet.content-defined-chunking.max-chunk-size` | Size in bytes       | 1048576                    | The maximum chunk size used for content-defined chunking                                                                                             |
