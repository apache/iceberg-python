...
@pytest.fixture
def many_batches(simple_schema):
...
class TestLimitDoesNotMaterializeFullScan:
    ...
    def test_limit_stops_consuming_generator_early(self, simple_schema, many_batches):
    ...
    def test_limit_returns_exact_row_count(self, simple_schema, many_batches):
    ...
    def test_no_limit_returns_all_rows(self, simple_schema, many_batches):
    ...
    def test_limit_larger_than_data_returns_all(self, simple_schema, many_batches):
...
class TestDeleteCoWStreamingWrite:
    ...
    def test_streaming_filter_preserves_row_count(self, simple_schema):
...
class TestDeleteCoWTwoPassStreaming:
    ...
    def test_streaming_two_pass_produces_correct_counts(self, simple_schema):
    ...
    def test_peak_memory_bounded_by_batch_size(self, simple_schema):
        ...
        def tracked_filter(batches_iter):
...
class TestCoWHybridSingleTwoPass:
    ...
    def test_small_file_reads_once(self):
    ...
    def test_large_file_reads_twice(self):
...
class TestCowStatsAllRowsDeleted:
    ...
    def test_strict_eval_drops_file_without_read(self, tmp_path):
        """File with min > delete threshold should be dropped entirely."""
        from pyiceberg.conversions import to_bytes
        from pyiceberg.expressions.visitors import ROWS_MUST_MATCH, _StrictMetricsEvaluator
...
class TestCowStatsNoRowsDeleted:
    ...
    def test_inclusive_eval_skips_file_without_read(self, tmp_path):
...
class TestCowStatsInconclusive:
    ...
    def test_straddling_bounds_are_inconclusive(self):
    ...
    def test_missing_stats_are_inconclusive(self):
...
class TestCowStatsWithNulls:
    ...
    def test_all_nulls_column_strict_eval(self):
    ...
    def test_no_nulls_column_isnotnull_strict_eval(self):
...
class TestCowThresholdIsConfigurable:
    ...
    def test_get_cow_threshold_returns_default_when_no_config(self):
    ...
    def test_env_var_accepts_small_value(self):
    ...
    def test_env_var_accepts_large_value(self):
...
class TestCowThresholdFromConfigFile:
    ...
    def test_config_file_sets_threshold(self, tmp_path, monkeypatch):
    ...
    def test_invalid_config_file_value_falls_back_to_default(self, tmp_path, monkeypatch):
...
class TestStreamingFilterBatchesSingleDefinition:
    ...
    def test_defined_in_orchestrate_module(self):
...
class TestStreamingFilterBatchesBehavior:
    ...
    def test_filters_rows_correctly(self):
    ...
    def test_all_batches_empty_after_filter_yields_nothing(self):
    ...
    def test_streaming_memory_model(self):
    ...
    def test_works_with_pyarrow_expression(self):
...
class TestWarnIfLargeMaterialization:
    ...
    def test_warning_includes_size_in_gb(self):
        """Warning message includes the size in human-readable GB."""
        import pyarrow as pa

        from pyiceberg.execution.backends.datafusion_backend import _warn_if_large_materialization
...
class TestGetExecutionConfigIntPriority:
    ...
    def test_default_value_when_nothing_set(self, tmp_path, monkeypatch):
    ...
    def test_config_file_overrides_default(self, tmp_path, monkeypatch):
    ...
    def test_dash_to_underscore_env_var_mapping(self, tmp_path, monkeypatch):
...
class TestCowMemoryErrorPropagation:
    ...
    def test_memory_error_not_swallowed(self):
        ...
        from pyiceberg.execution.backends.pyarrow_backend import PyArrowComputeBackend, PyArrowWriteBackend
...
class TestCowDeleteRespectsExistingDeletes:
    ...
    @pytest.fixture
    def cow_table_with_pos_deletes(self, tmp_path):
    ...
    def test_cow_small_file_excludes_position_deleted_rows(self, cow_table_with_pos_deletes, tmp_path):
    ...
    def test_cow_large_file_streaming_excludes_position_deleted_rows(self, cow_table_with_pos_deletes, tmp_path):
    ...
    def test_cow_with_equality_deletes_excludes_eq_deleted_rows(self, tmp_path):
    ...
    def test_cow_with_combined_pos_and_eq_deletes(self, tmp_path):
    ...
    def test_cow_no_deletes_falls_through_to_raw_read(self, tmp_path):
