...
class TestBackendsIoPropertiesField:
    ...
    def test_io_properties_is_declared_dataclass_field(self):
    ...
    def test_io_properties_accessible_without_type_ignore(self):
    ...
    def test_io_properties_passed_through_resolve(self):
    ...
    def test_io_properties_equality_in_dataclass(self):
...
class TestBackendsResolveValidation:
    ...
    def test_invalid_read_override_raises_type_error(self):
    ...
    def test_write_string_override_resolves_pyarrow(self):
    ...
    def test_write_string_override_rejects_unknown(self):
    ...
    def test_invalid_write_override_raises_type_error(self):
    ...
    def test_invalid_compute_override_raises_type_error(self):
    ...
    def test_error_message_includes_missing_methods(self):
...
class TestConfigResolution:
    ...
    def test_env_var_sets_compute_backend(self):
    ...
    def test_env_var_invalid_backend_raises(self):
    ...
    def test_auto_detect_disabled_via_env(self):
...
class TestInstantiateWriteAlwaysPyArrow:
    ...
    def test_instantiate_write_takes_no_parameters(self):
    ...
    def test_instantiate_write_returns_pyarrow_write_backend(self):
    ...
    def test_backends_resolve_always_produces_pyarrow_write(self):
...
class TestScopedEnvVarsSerializationWarning:
    ...
    def test_no_warning_on_fast_path(self):
    ...
    def test_no_warning_when_env_map_is_empty(self):
...
class TestRegistryDeclarative:
    ...
    def test_read_registry_is_dict_of_tuples(self):
    ...
    def test_compute_registry_is_dict_of_tuples(self):
    ...
    def test_write_backend_registry_has_pyarrow(self):
...
class TestRegistryConsistencyWithEnum:
    ...
    def test_read_registry_keys_match_enum_names(self):
    ...
    def test_compute_registry_keys_match_enum_names(self):
    ...
    def test_pyarrow_always_in_both_registries(self):
        """PYARROW must always be registered (it is the mandatory fallback)."""
        from pyiceberg.execution.engine import _COMPUTE_BACKEND_REGISTRY, _READ_BACKEND_REGISTRY
    ...
    def test_every_engine_has_at_least_read_and_compute_entries(self):
...
class TestRegistryInstantiation:
    ...
    def test_pyarrow_read_instantiates_correctly(self):
    ...
    def test_pyarrow_compute_instantiates_correctly(self):
    ...
    def test_datafusion_read_instantiates_when_available(self):
    ...
    def test_datafusion_compute_instantiates_when_available(self):
    ...
    def test_unknown_engine_falls_back_to_pyarrow(self):
        """An engine name not in the registry falls back to PyArrow."""
        from pyiceberg.execution.backends.pyarrow_backend import PyArrowComputeBackend
        from pyiceberg.execution.engine import _COMPUTE_BACKEND_REGISTRY, _instantiate_from_registry
    ...
    def test_missing_package_raises_import_error_with_hint(self):
...
class TestRegistryLazyImport:
    ...
    def test_importing_protocol_does_not_import_datafusion(self):
    ...
    def test_instantiate_uses_importlib(self):
...
class TestResolveExplicitDerivedFromEnum:
    ...
    def test_all_enum_variants_are_valid_config_strings(self):
        """Every ExecutionEngine.name.lower() must be accepted by _resolve_explicit."""
        from pyiceberg.execution.engine import _detect_available_engines, _resolve_explicit
    ...
    def test_no_hardcoded_mapping_dict(self):
...
class TestRegistryExtensibility:
    ...
    def test_adding_entry_to_registry_enables_instantiation(self):
    ...
    def test_registry_does_not_require_code_changes_for_new_backend(self):
...
class TestSchemaCacheThreadSafetyDocumentation:
    ...
    def test_comment_mentions_idempotent(self):
    ...
    def test_comment_does_not_claim_dict_atomicity(self):
    ...
    def test_comment_mentions_deterministic_or_pure(self):
...
class TestPublicModulesDeclareAll:
    ...
    def test_expression_to_sql_has_all(self):
    ...
    def test_expression_to_sql_all_contains_public_function(self):
    ...
    def test_object_store_has_all(self):
    ...
    def test_object_store_all_contains_public_functions(self):
    ...
    def test_materialize_has_all(self):
    ...
    def test_materialize_all_contains_public_functions(self):
    ...
    def test_planning_has_all(self):
    ...
    def test_planning_all_contains_public_classes(self):
    ...
    def test_private_modules_do_not_need_all(self):
...
class TestGetMemoryLimit:
    ...
    def test_config_file_overrides_default(self):
        ...
        from pyiceberg.execution.engine import _read_execution_section_from_file, get_memory_limit
    ...
    def test_env_var_beats_config_file(self):
...
class TestGetExecutionConfigInt:
    ...
    def test_env_var_dashes_become_underscores(self):
    ...
    def test_invalid_env_var_falls_through_to_default(self):
    ...
    def test_yaml_config_used_when_no_env_var(self, tmp_path, monkeypatch):
        """Config file value is used when no env var is set."""
        from pyiceberg.execution.engine import clear_config_cache, get_execution_config_int
    ...
    def test_env_var_overrides_yaml_config(self, tmp_path, monkeypatch):
    ...
    def test_cached_section_avoids_repeated_disk_reads(self):
        """Multiple calls to get_execution_config_int share the cached section read."""
        from pyiceberg.execution.engine import _read_execution_section_from_file, get_execution_config_int
    ...
    def test_clear_config_cache_invalidates_section_cache(self, tmp_path, monkeypatch):
