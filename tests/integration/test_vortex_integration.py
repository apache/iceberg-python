...
class TestVortexTableOperations:
    ...
    def test_multiple_append_operations(
        self, vortex_catalog: SqlCatalog, test_schema: Schema, test_data: pa.Table
    ) -> None:
    ...
    def test_vortex_table_filtering(
        self, vortex_catalog: SqlCatalog, test_schema: Schema, test_data: pa.Table
    ) -> None:
    ...
    def test_catalog_persistence_with_vortex(
        self, tmp_path: Path, test_schema: Schema, test_data: pa.Table
    ) -> None:
