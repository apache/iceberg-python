...
def test_python_writes_special_character_column_with_spark_reads(
    ...
    tbl = _create_table(session_catalog, identifier, {"format-version": str(format_version)}, schema=pa_schema)
...
def test_hive_catalog_storage_descriptor(
    ...
    tbl = _create_table(
        session_catalog_hive, "default.test_storage_descriptor", {"format-version": str(format_version)}, [arrow_table_with_null]
    )
