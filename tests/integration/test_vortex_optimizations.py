...
def test_vortex_optimizations():
    ...
    try:
        ...
        table = catalog.create_table(
            identifier="default.test_vortex_optimization",
            schema=schema,
        ...
        test_data = pa.table({
            ...
            "name": pa.array(["Alice", "Bob", "Charlie", "Dave", "Eve", "Frank", "Grace", "Henry", "Ivy", "Jack"], type=pa.string()),
        ...
        result = table.scan(
            row_filter=GreaterThan("value", 50)
        ).to_arrow()
