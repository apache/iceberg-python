...
def test_read_manifest_entry(generated_manifest_entry_file: str) -> None:
    ...
    assert (
        data_file.file_path
        == "/home/iceberg/warehouse/nyc/taxis_partitioned/data/VendorID=null/00000-633-d8a4223e-dc97-45a1-86e1-adaba6e8abd7-00001.parquet"  # noqa: E501
    )
...
def test_write_manifest(
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        expected_metadata = {
            ...
            "partition-spec": """[{"source-id":1,"field-id":1000,"transform":"identity","name":"VendorID"},{"source-id":2,"field-id":1001,"transform":"day","name":"tpep_pickup_day"}]""",  # noqa: E501
