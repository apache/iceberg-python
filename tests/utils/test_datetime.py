...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("2025-02-23T20:21:44.375612001Z", 1740342104375612001),
        ("1970-01-01T00:00:00Z", 0),
        ("1970-01-01T00:00:00z", 0),
        ("2025-02-23T20:21Z", 1740342060000000000),
        ("2025-02-23T16:21-04:00", 1740342060000000000),
    ],
)
...
@pytest.mark.parametrize(
    "timestamp, micros",
    [
        ("2025-02-23T16:21:44.375612-04:00", 1740342104375612),
        ("2025-02-23T20:21:44.375612+00:00", 1740342104375612),
        ("2025-02-23T20:21:44.375612Z", 1740342104375612),
        ("1970-01-01T00:00:00Z", 0),
        ("1970-01-01T00:00:00z", 0),
        ("2025-02-23T20:21Z", 1740342060000000),
        ("2025-02-23T16:21-04:00", 1740342060000000),
    ],
)
def test_timestamptz_to_micros(timestamp: str, micros: int) -> None:
    assert micros == timestamptz_to_micros(timestamp)
