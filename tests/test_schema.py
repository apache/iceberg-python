...
def test_schema_repr_single_field() -> None:
    ...
    expected = "Schema(NestedField(field_id=1, name='foo', field_type=StringType(), required=False), schema_id=1, identifier_field_ids=[])"  # noqa: E501
...
def test_schema_repr_two_fields() -> None:
    ...
    expected = "Schema(NestedField(field_id=1, name='foo', field_type=StringType(), required=False), NestedField(field_id=2, name='bar', field_type=IntegerType(), required=False), schema_id=1, identifier_field_ids=[])"  # noqa: E501
    assert expected == actual
...
def test_identifier_fields_fails(table_schema_nested_with_struct_key_map: Schema) -> None:
    ...
    assert (
        f"Cannot add field zip as an identifier field: must not be nested in {table_schema_nested_with_struct_key_map.find_field('location')}"  # noqa: E501
    ...
    assert (
        f"Cannot add field x as an identifier field: must not be nested in {table_schema_nested_with_struct_key_map.find_field('points')}"  # noqa: E501
        in str(exc_info.value)
    )
    ...
    assert (
        f"Cannot add field age as an identifier field: must not be nested in an optional field {table_schema_nested_with_struct_key_map.find_field('person')}"  # noqa: E501
        in str(exc_info.value)
    )
