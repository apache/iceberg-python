...
def test_add_top_level_primitives(primitive_fields: NestedField) -> None:
    for primitive_field in primitive_fields:
        ...
        applied = UpdateSchema(transaction=None, table_metadata=None, schema=Schema()).union_by_name(new_schema)._apply()  # type: ignore
...
def test_add_nested_primitives(primitive_fields: NestedField) -> None:
    ...
    applied = UpdateSchema(transaction=None, table_metadata=None, schema=current_schema).union_by_name(new_schema)._apply()  # type: ignore
    assert applied.as_struct() == new_schema.as_struct()
...
def test_detect_invalid_top_level_list() -> None:
    ...
    with pytest.raises(ValidationError, match="Cannot change column type: aList.element: string -> double"):
        _ = UpdateSchema(transaction=None, table_metadata=None, schema=current_schema).union_by_name(new_schema)._apply()  # type: ignore
...
def test_mirrored_schemas() -> None:
    ...
    applied = UpdateSchema(transaction=None, table_metadata=None, schema=current_schema).union_by_name(mirrored_schema)._apply()  # type: ignore
...
def test_add_new_top_level_struct() -> None:
    ...
    applied = UpdateSchema(transaction=None, table_metadata=None, schema=current_schema).union_by_name(observed_schema)._apply()  # type: ignore
...
def test_append_nested_lists() -> None:
    ...
    union = UpdateSchema(transaction=None, table_metadata=None, schema=current_schema).union_by_name(observed_schema)._apply()  # type: ignore
...
def test_union_with_pa_schema(primitive_fields: NestedField) -> None:
    ...
    new_schema = UpdateSchema(transaction=None, table_metadata=None, schema=base_schema).union_by_name(pa_schema)._apply()  # type: ignore
